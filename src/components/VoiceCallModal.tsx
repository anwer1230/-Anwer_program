            ...
            <div className="relative w-full h-56 rounded-3xl bg-zinc-900 border border-zinc-800 flex items-center justify-center overflow-hidden shadow-inner">
              {callType === 'video' && inCall && !isVideoOff ? (
                ...
                <div className="flex flex-col items-center text-center p-4">
                  ...
                  {/* 4 Emojis E2EE Key Verification Badge (Official Telegram Spec) */}
                  {inCall && (
                    <div className="mt-2 flex items-center gap-1 bg-black/60 backdrop-blur-md px-2.5 py-1 rounded-full border border-emerald-500/30 text-xs shadow-inner">
                      <span title="تشفير طرف لطرف">🔒</span>
                      <span className="text-sm">🐱 🚀 🔑 🌟</span>
                      <span className="text-[10px] text-emerald-400 font-bold mr-1">E2EE مشفّر</span>
                    </div>
                  )}
                </div>
              )}
